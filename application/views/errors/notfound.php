...
<body>
  <main class="h-screen w-full flex flex-col justify-center items-center">
    <div class="bg-[#1A2238] h-screen justify-center">
      <center class="mt-24 m-auto">
        <svg class="emoji-404 " enable-background="new 0 0 226 249.135" height="249.135" id="Layer_1" overflow="visible" version="1.1" viewBox="0 0 226 249.135" width="226" xml:space="preserve">
          ...
          <circle cx="113" cy="113" fill="none" r="109" stroke="pink" stroke-width="8" />
        </svg>
        <div class=" tracking-widest mt-6">
          <span class="text-gray-500 text-6xl block"><span>4 0 4</span></span>
          <span class="text-gray-500 text-xl">Maaf, Kami tidak dapat menemukan yang Anda cari!</span>
        </div>
      </center>
      <center class="mt-10">
        <a href="<?= base_url('/') ?>" class="text-gray-100 font-mono text-xl bg-red-700 hover:bg-red-800 p-3 rounded-md hover:shadow-md">Kembali</a>
      </center>
    </div>
  </main>
</body>
