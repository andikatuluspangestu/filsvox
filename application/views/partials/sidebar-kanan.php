...
<aside class=" w-1/5 pt-12 pb-10 px-10  min-w-min  border-none border-gray-300 dark:border-zinc-700 hidden lg:block ">
    ...
    <ul class="mt-4 text-gray-400 text-xs space-y-3">
      ...
      <?php foreach ($popular as $pop) : ?>
        <li class="flex space-x-3 ">
          <img src="<?= $pop->cover; ?>" class="object-cover w-1/3 h-20 rounded-md" alt="">
          <div class="flex flex-col justify-between  ">
            ...
            <div class="flex space-x-2 items-center">
              <span>Rilis : <?= $pop->release_date; ?></span>
            </div>
          </div>
        </li>
      <?php endforeach; ?>
  ...
  <!-- Film Terfavorit -->
  <!-- <div class="mt-10">
    <span class="font-semibold text-white">Favorites</span>
    <ul class="mt-4 text-gray-400 text-xs space-y-3">
      <li class="flex space-x-3 ">
        <img src="https://upload.wikimedia.org/wikipedia/en/c/c1/The_Matrix_Poster.jpg" class="object-cover w-1/3 rounded-md" alt="">
        <div class="flex flex-col justify-between  ">
          <div class="flex flex-col space-y-1">
            <span class="text-gray-400 dark:text-white font-semibold">The Matrix</span>
