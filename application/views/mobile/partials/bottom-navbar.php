 <section id="bottom-navigation" class="block fixed inset-x-0 bottom-0 z-5 bg-slate-900 shadow m-4 px-4 rounded-2xl">
   <div id="myTab" data-tabs-toggle="#myTabContent" role="tablist" class="flex justify-between">
     ...
     <!-- Home -->
     <button class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center py-1" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="true" role="presentation">
       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 22 22" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block mb-1">
     ...
     <!-- Category -->
     <button class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center py-1" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false" role="presentation">
     ...
     <!-- Explore -->
     <button class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center py-1" id="explore-tab" data-tabs-target="#explore" type="button" role="tab" aria-controls="explore" aria-selected="false" role="presentation">
       ...
       <span class="tab tab-kategori block text-xs">Explore</span>
     </button>

     <!-- Soon -->
     <button class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1" id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false" role="presentation">
       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block mb-1">
