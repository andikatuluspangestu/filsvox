    ...
    <div class="justify-center items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
      ...
      <form action="<?= base_url('/search/explore/') ?>">
        ...
        <div class="relative">
          ...
          <input name="keyword" type="search" id="default-search" class="block p-4 pl-10 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="Search Artist, Writer..." required="">
