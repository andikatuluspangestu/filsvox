<aside id="sidebar" class="fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
  <div class="relative flex-1 flex flex-col min-h-0 border-gray-200 bg-gray-900 pt-5">
    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
      <div class="flex-1 px-3 bg-gray-900 divide-y space-y-1">
        <ul class="space-y-2 pb-2">
          <!-- Sidebar -->
          <li>
            <a href="<?= site_url('admin') ?>" class="text-base bg-gray-800 text-gray-100 font-normal rounded-lg flex items-center p-2 hover:bg-gray-700 group">
          ...
          <li>
            <a href="<?= site_url('admin/post') ?>" class="text-base bg-gray-800 text-gray-100 font-normal rounded-lg flex items-center p-2 hover:bg-gray-700 group">
          ...
          <li>
            <a href="#" class="text-base bg-gray-800 text-gray-100 font-normal rounded-lg flex items-center p-2 hover:bg-gray-700 group">
