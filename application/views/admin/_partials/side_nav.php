    ...
    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
      <div class="flex-1 px-3 bg-gray-900 divide-y space-y-1">
        <ul class="space-y-2 pb-2">
          ...
          <!-- Sidebar -->
          <li>
            <a href="<?= site_url('admin') ?>" class="side-item hover:text-gray-100 text-base bg-gray-800 text-gray-100 font-normal rounded-lg flex items-center p-2 hover:bg-gray-700 group">
          ...
          <li>
            <a href="<?= site_url('admin/post') ?>" class="side-item hover:text-gray-100 text-base bg-gray-800 text-gray-100 font-normal rounded-lg flex items-center p-2 hover:bg-gray-700 group">
          ...
          <li>
            <a href="<?= site_url('admin/category') ?>" class="side-item hover:text-gray-100 text-base bg-gray-800 text-gray-100 font-normal rounded-lg flex items-center p-2 hover:bg-gray-700 group">
          ...
          <?php if ($current_user->role == 1) : ?>
            <li>
              <a href="<?= site_url('admin/user') ?>" class="side-item hover:text-gray-100 text-base bg-gray-800 text-gray-100 font-normal rounded-lg flex items-center p-2 hover:bg-gray-700 group">
                <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-100 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <li>
            <a href="<?= site_url('admin/setting') ?>" class="side-item text-base bg-gray-800 text-gray-100 font-normal rounded-lg flex items-center p-2 hover:bg-gray-700 hover:text-gray-100 group">
