          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
              <div class="w-full px-3">
                ...
                <input name="title" class="form-input block w-full mt-1" id="grid-title" type="text" value="<?= $article->title ?>" required title=" Judul Artikel Wajib di isi">
              </div>
            </div>
            ...
            <!-- <div class="-mx-3 mb-6">
              <div class="w-full px-3">
                ...
                <div id="editor" class="bg-white">
                  <textarea name="content" id="content" class="hidden"><?= $article->content ?></textarea>
                </div>
              </div>
            </div> -->
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
              <div class="w-full px-3">
                ...
                <textarea name="content" class="form-input block w-full mt-1" id="grid-content" type="text" required title=" Konten Wajib di isi"><?= $article->content ?></textarea>
              </div>
            </div>
